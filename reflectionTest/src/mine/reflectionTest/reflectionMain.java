...
public class reflectionMain {
	...
	public static void test01() throws ClassNotFoundException {
		Class c1 = reflectionMain.class;
		Class c2 = Class.forName("mine.reflectionTest.reflectionMain");
		//获取指定的包名
		...
		for (Constructor constructor : constructors) {
			...
			modifier = Modifier.toString(constructor.getModifiers()); // 获取方位修饰符
	...
	public static void test02() throws InstantiationException,IllegalAccessException, SecurityException, NoSuchMethodException,
	...
	//若反射要调用类的某个私有方法，可以在这个私有方法对应的Mehtod对象上先调用setAccessible(true)
	  Class c1 = reflectionMain.class;
	  reflectionMain t1 = (reflectionMain) c1.newInstance(); //利用反射来创建类的对象
